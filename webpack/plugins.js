...
const globals = () => [
  new webpack.DefinePlugin({
    ...
    "process.env.QUERY_MINIFICATION": Env.QUERY_MINIFICATION,
    "process.env.BASE_RELATIVE_PATH": JSON.stringify(Env.BASE_RELATIVE_PATH)
  })
];
...
const extractCSS = () => {
  ...
  const nameConvention = hashing
    ? "assets-ui/styles/[name].[chunkhash].chunk.css"
    : "assets-ui/styles/[name].chunk.css";
  return [
...
const globalDefinitions = () => [new webpack.ProvidePlugin({
  React: "react"
})]
